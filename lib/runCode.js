...
//////////////////////////////
//// if it errors out, are we losing out on that traceLog?
    //// emit trace logs event here!
      var traceObj = {
        depth: runState.depth,
        // error: runState.??, vmError is a bool
        // gas: runState.gasLeft, ???
        // gasCost: BN(lookupOpInfo(opCode).fee), ???
        memory: runState.memory,
        op: lookupOpInfo(opCode, true),
        pc: runState.programCounter,
        stack: runState.stack,
        // storage: runState.storage
      }
      self.emit('trace', traceObj, cb)
//////////////////////////////
